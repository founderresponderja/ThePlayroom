...
export const archetypes: Record<string, { emoji: string; title: string; description: string }> = {
  'The Adventurer': {
    emoji: '🌋',
    title: 'O Aventureiro',
    description: 'Aberto a tudo, vives o lifestyle com intensidade e curiosidade sem limites.',
  },
  'The Explorer': {
    emoji: '🗺️',
    title: 'O Explorador',
    description: 'Gostas de descobrir novas experiências, com critério e ao teu ritmo.',
  },
  'The Curious': {
    emoji: '🔍',
    title: 'O Curioso',
    description: 'Ainda a descobrir o que o lifestyle tem para oferecer. Com calma e confiança.',
  },
  'The Selective': {
    emoji: '💎',
    title: 'O Selectivo',
    description: 'Qualidade acima de quantidade. Sabes exactamente o que queres.',
  },
}
